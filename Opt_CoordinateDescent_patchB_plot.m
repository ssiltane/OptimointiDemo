% Plot coordinate descent method, showing only local patches of the objective
% function.
%
...
while (iii<Niter)&(gradnorm>gradtol)
    ...
    % Save to file
    filename = ['frames_Coord_patchB/OptFrameCoordB_',num2str(imcounter),'.png'];
...
% Save to file
filename = ['frames_Coord_patchB/OptFrameCoordB_0.png'];
imwrite(uint8(im3),filename,'png');
